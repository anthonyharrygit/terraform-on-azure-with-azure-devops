...
variable "gateway_subnet_name" {
  description = "Virtual Network gateway Subnet Name"
  type = string
  default = "GatewaySubnet"
}
# gatewaysubnet Subnet Address Space
variable "gateway_subnet_address" {
  description = "Virtual Network gateway Subnet Address Spaces"
  type = list(string)
  default = ["v10.0.31.0/24"]
}
